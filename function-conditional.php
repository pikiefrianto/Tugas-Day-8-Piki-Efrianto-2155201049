...
greetings("Piki Efrianto");
echo "<br>";
greetings("Habib Ramadhan");
echo "<br>";
greetings("Muhammad Fadhil Rasya");
echo "<br>";
greetings("Andri Setiawan");
echo "<br>";
greetings("Abigail Fadzillah");
echo "<br>";
...
reverseString("otnairfE ikiP");
echo "<br>";
reverseString("ETUTITSNI REBYC ADURAG");
echo "<br>";
reverseString("repoleveD snI-CG erA eW");
echo "<br>";
